...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-orange-50 to-orange-100 pt-16">
            ...
            <div className="animate-fade-in">
              <div className="h-96 rounded-2xl relative overflow-hidden shadow-xl">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center p-12 text-white bg-black bg-opacity-50 rounded-lg w-4/5 h-4/5 flex flex-col justify-center">
                    <div className="w-32 h-32 bg-orange-600 rounded-full flex items-center justify-center mx-auto mb-8">
                      <svg className="w-16 h-16 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                      </svg>
                    </div>
                    <h3 className="text-4xl font-bold mb-4">{language === 'en' ? 'Strategic Excellence' : 'Excellence Stratégique'}</h3>
                    <p className="text-orange-200 text-xl font-medium mb-6">{language === 'en' ? 'Innovation • Growth • Success' : 'Innovation • Croissance • Succès'}</p>
